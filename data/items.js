...
export const ITEMS = {
  ...
  /* --------------------------- Bronze set -------------------------- */
  bronze_helm:   { id: 'bronze_helm',   name: 'Bronze Helm',     type: 'equipment', slot: 'head',   def: 5,  sell: 12, img: 'assets/equipment/bronze-helm.png',   tint: 'bronze', reqDef: 10 },
  bronze_plate:  { id: 'bronze_plate',  name: 'Bronze Plate',    type: 'equipment', slot: 'body',   def: 12, sell: 28, img: 'assets/equipment/bronze-plate.png',  tint: 'bronze', reqDef: 10 },
  bronze_legs:   { id: 'bronze_legs',   name: 'Bronze Greaves',  type: 'equipment', slot: 'legs',   def: 8,  sell: 20, img: 'assets/equipment/bronze-legs.png',   tint: 'bronze', reqDef: 10 },
  bronze_gloves: { id: 'bronze_gloves', name: 'Bronze Gloves',   type: 'equipment', slot: 'gloves', def: 3,  sell: 6,  img: 'assets/equipment/bronze-gloves.png', tint: 'bronze', reqDef: 10 },
  bronze_boots:  { id: 'bronze_boots',  name: 'Bronze Boots',    type: 'equipment', slot: 'boots',  def: 3,  sell: 6,  img: 'assets/equipment/bronze-boots.png',  tint: 'bronze', reqDef: 10 },
  bronze_shield: { id: 'bronze_shield', name: 'Bronze Shield',   type: 'equipment', slot: 'shield', def: 10, sell: 24, img: 'assets/equipment/bronze-shield.png', tint: 'bronze', reqDef: 10 },
  bronze_dagger: { id: 'bronze_dagger', name: 'Bronze Dagger',   type: 'equipment', slot: 'weapon', atk: 9,  str: 4,  sell: 16, img: 'assets/equipment/bronze-dagger.png', tint: 'bronze', reqAtk: 10 },
  bronze_sword:  { id: 'bronze_sword',  name: 'Bronze Sword',    type: 'equipment', slot: 'weapon', atk: 12, str: 9,  sell: 28, img: 'assets/equipment/bronze-sword.png',  tint: 'bronze', reqAtk: 10 },
  bronze_hammer: { id: 'bronze_hammer', name: 'Bronze Hammer',   type: 'equipment', slot: 'weapon', atk: 8,  str: 16, sell: 28, img: 'assets/equipment/bronze-hammer.png', tint: 'bronze', reqAtk: 10 },

  /* ---------------------------- Iron set --------------------------- */
  iron_helm:   { id: 'iron_helm',   name: 'Iron Helm',     type: 'equipment', slot: 'head',   def: 8,  sell: 22, img: 'assets/equipment/bronze-helm.png',   tint: 'iron', reqDef: 20 },
  iron_plate:  { id: 'iron_plate',  name: 'Iron Plate',    type: 'equipment', slot: 'body',   def: 18, sell: 42, img: 'assets/equipment/bronze-plate.png',  tint: 'iron', reqDef: 20 },
  iron_legs:   { id: 'iron_legs',   name: 'Iron Greaves',  type: 'equipment', slot: 'legs',   def: 12, sell: 32, img: 'assets/equipment/bronze-legs.png',   tint: 'iron', reqDef: 20 },
  iron_gloves: { id: 'iron_gloves', name: 'Iron Gloves',   type: 'equipment', slot: 'gloves', def: 5,  sell: 12, img: 'assets/equipment/bronze-gloves.png', tint: 'iron', reqDef: 20 },
  iron_boots:  { id: 'iron_boots',  name: 'Iron Boots',    type: 'equipment', slot: 'boots',  def: 5,  sell: 12, img: 'assets/equipment/bronze-boots.png',  tint: 'iron', reqDef: 20 },
  iron_shield: { id: 'iron_shield', name: 'Iron Shield',   type: 'equipment', slot: 'shield', def: 15, sell: 38, img: 'assets/equipment/bronze-shield.png', tint: 'iron', reqDef: 20 },
  iron_dagger: { id: 'iron_dagger', name: 'Iron Dagger',   type: 'equipment', slot: 'weapon', atk: 13, str: 6,  sell: 24, img: 'assets/equipment/bronze-dagger.png', tint: 'iron', reqAtk: 20 },
  iron_sword:  { id: 'iron_sword',  name: 'Iron Sword',    type: 'equipment', slot: 'weapon', atk: 16, str: 12, sell: 40, img: 'assets/equipment/bronze-sword.png',  tint: 'iron', reqAtk: 20 },
  iron_hammer: { id: 'iron_hammer', name: 'Iron Hammer',   type: 'equipment', slot: 'weapon', atk: 11, str: 25, sell: 40, img: 'assets/equipment/bronze-hammer.png', tint: 'iron', reqAtk: 20 },

  /* --------------------------- Steel set --------------------------- */
  steel_helm:   { id: 'steel_helm',   name: 'Steel Helm',     type: 'equipment', slot: 'head',   def: 12, sell: 34, img: 'assets/equipment/bronze-helm.png',   tint: 'steel', reqDef: 30 },
  steel_plate:  { id: 'steel_plate',  name: 'Steel Plate',    type: 'equipment', slot: 'body',   def: 27, sell: 64, img: 'assets/equipment/bronze-plate.png',  tint: 'steel', reqDef: 30 },
  steel_legs:   { id: 'steel_legs',   name: 'Steel Greaves',  type: 'equipment', slot: 'legs',   def: 18, sell: 48, img: 'assets/equipment/bronze-legs.png',   tint: 'steel', reqDef: 30 },
  steel_gloves: { id: 'steel_gloves', name: 'Steel Gloves',   type: 'equipment', slot: 'gloves', def: 8,  sell: 18, img: 'assets/equipment/bronze-gloves.png', tint: 'steel', reqDef: 30 },
  steel_boots:  { id: 'steel_boots',  name: 'Steel Boots',    type: 'equipment', slot: 'boots',  def: 8,  sell: 18, img: 'assets/equipment/bronze-boots.png',  tint: 'steel', reqDef: 30 },
  steel_shield: { id: 'steel_shield', name: 'Steel Shield',   type: 'equipment', slot: 'shield', def: 22, sell: 60, img: 'assets/equipment/bronze-shield.png', tint: 'steel', reqDef: 30 },
  steel_dagger: { id: 'steel_dagger', name: 'Steel Dagger',   type: 'equipment', slot: 'weapon', atk: 18, str: 8,  sell: 38, img: 'assets/equipment/bronze-dagger.png', tint: 'steel', reqAtk: 30 },
  steel_sword:  { id: 'steel_sword',  name: 'Steel Sword',    type: 'equipment', slot: 'weapon', atk: 22, str: 16, sell: 62, img: 'assets/equipment/bronze-sword.png',  tint: 'steel', reqAtk: 30 },
  steel_hammer: { id: 'steel_hammer', name: 'Steel Hammer',   type: 'equipment', slot: 'weapon', atk: 15, str: 35, sell: 62, img: 'assets/equipment/bronze-hammer.png', tint: 'steel', reqAtk: 30 },

  /* ------------------------ Blacksteel set ------------------------- */
  blacksteel_helm:   { id: 'blacksteel_helm',   name: 'Blacksteel Helm',    type: 'equipment', slot: 'head',   def: 18, sell: 120, img: 'assets/equipment/helm.png',   tint: 'blacksteel', reqDef: 40 },
  blacksteel_plate:  { id: 'blacksteel_plate',  name: 'Blacksteel Plate',   type: 'equipment', slot: 'body',   def: 38, sell: 260, img: 'assets/equipment/plate.png',  tint: 'blacksteel', reqDef: 40 },
  blacksteel_legs:   { id: 'blacksteel_legs',   name: 'Blacksteel Greaves', type: 'equipment', slot: 'legs',   def: 26, sell: 190, img: 'assets/equipment/legs.png',   tint: 'blacksteel', reqDef: 40 },
  blacksteel_gloves: { id: 'blacksteel_gloves', name: 'Blacksteel Gloves',  type: 'equipment', slot: 'gloves', def: 12, sell: 90,  img: 'assets/equipment/gloves.png', tint: 'blacksteel', reqDef: 40 },
  blacksteel_boots:  { id: 'blacksteel_boots',  name: 'Blacksteel Boots',   type: 'equipment', slot: 'boots',  def: 12, sell: 90,  img: 'assets/equipment/boots.png',  tint: 'blacksteel', reqDef: 40 },
  blacksteel_shield: { id: 'blacksteel_shield', name: 'Blacksteel Shield',  type: 'equipment', slot: 'shield', def: 30, sell: 220, img: 'assets/equipment/shield.png', tint: 'blacksteel', reqDef: 40 },
  blacksteel_dagger: { id: 'blacksteel_dagger', name: 'Blacksteel Dagger',  type: 'equipment', slot: 'weapon', atk: 24, str: 12, sell: 160, img: 'assets/equipment/dagger.png', tint: 'blacksteel', reqAtk: 40 },
  blacksteel_sword:  { id: 'blacksteel_sword',  name: 'Blacksteel Sword',   type: 'equipment', slot: 'weapon', atk: 30, str: 22, sell: 280, img: 'assets/equipment/sword.png',  tint: 'blacksteel', reqAtk: 40 },
  blacksteel_axe:    { id: 'blacksteel_axe',    name: 'Blacksteel Axe',     type: 'equipment', slot: 'weapon', atk: 20, str: 40, sell: 280, img: 'assets/equipment/axe.png',   tint: 'blacksteel', reqAtk: 40 },
