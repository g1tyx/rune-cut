...
export const FORGE_RECIPES = [
  ...
  { id:'starsteel_plate',  name:'Starsteel Platebody', level:55, time:5600, reqSkill:'smith', speedSkill:'smith', metal:'starsteel', inputs:[{id:'bar_starsteel',qty:1}], outputs:[{id:'starsteel_plate',qty:1}],  xp:[{skill:'smith',amount:750}], rareChance:0.10, rareId:'starsteel_plate_rare' },
