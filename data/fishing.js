export const FISHING_SPOTS = [
  ...
  { id: 'coast_halibut',     name: 'Coast',          level: 30, baseTime: 3400, drop: 'raw_halibut',       xp: 75 },
  { id: 'open_ocean_manta',  name: 'Open Ocean',     level: 40, baseTime: 3600, drop: 'raw_manta_ray',     xp: 120 },
  { id: 'abyssal_angler',    name: 'Abyssal Trench', level: 50, baseTime: 3800, drop: 'raw_angler',        xp: 175 },
