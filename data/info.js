...
export const SKILL_INFO = {
  ...
  devlog: {
    tips: [
      "<h3>Version: 1.6.37</h3>",
      "Added new Destruction spells",
      "fixed bug with Sterling pet being unlocked with zero stats",
      "added forge bellows to Mechanics",
      "<h3>Version: 1.6.36</h3>",
      "Camp huts - Cedar through Runewood",
      "<h3>Version: 1.6.35</h3>",
      "Added new weapon poison and farming",
      "Fixed weapon poison bug",
      "Added Dual amulet enchant",
      "Added New Mechanical items",
      "Added Stop button to other production actions",
      "<h3>Version: 1.6.34</h3>",
      "Added Inventory search",
      "Amulet Enchanting",
      "Enchanting filters",
      "Added Silynara well-fed boost",
      "Keep seed selection on farming",
